...
/// at least 1 jet
	...
	ZMass_Zinc1jet                      = newTH1D("ZMass_Zinc1jet",                      "Z Invariant Mass (N_{jets} #geq 1)",          Mll,    210, 50, 260 );
...
///// end min dR in leading jet Pt case
	...
	SecondBJetPt_Zinc2Bjet = newTH1D("SecondBJetPt_Zinc2B","b-jet pt (inc 2 b jet)","b-jet pt", nbins, 0, maxX);
	BJetsMass_Zexc2Bjet= newTH1D("BJetsMass_Zexc2", "b-jet mass inc 2 b-jet ","b jet mass",  nbins, 0, maxX);
	FirstBJetPt_Zexc1Bjet = newTH1D("FirstBJetPt_Zexc1B","b-jet pt (inc 1 b jet)","b-jet pt", nbins, 0, maxX);
	...
	SecondBJetPt_Zinc2Bjet_l = newTH1D("SecondBJetPt_Zinc2B_l","b-jet pt (inc 2 b jet)","b-jet pt", nbins, 0, maxX);
	BJetsMass_Zexc2Bjet_l= newTH1D("BJetsMass_Zexc2_l", "b-jet mass inc 2 b-jet ","b jet mass",  nbins, 0, maxX);
	...
	SecondBJetPt_Zinc2Bjet_c = newTH1D("SecondBJetPt_Zinc2B_c","b-jet pt (inc 2 b jet)","b-jet pt", nbins, 0, maxX);
	BJetsMass_Zexc2Bjet_c= newTH1D("BJetsMass_Zexc2_c", "b-jet mass inc 2 b-jet ","b jet mass",  nbins, 0, maxX);
	FirstBJetPt_Zexc1Bjet_c = newTH1D("FirstBJetPt_Zexc1B_c","b-jet pt (inc 1 b jet)","b-jet pt", nbins, 0, maxX);
	...
	SecondBJetPt_Zinc2Bjet_b = newTH1D("SecondBJetPt_Zinc2B_b","b-jet pt (inc 2 b jet)","b-jet pt", nbins, 0, maxX);
	BJetsMass_Zexc2Bjet_b= newTH1D("BJetsMass_Zexc2_b", "b-jet mass inc 2 b-jet ","b jet mass",  nbins, 0, maxX);
